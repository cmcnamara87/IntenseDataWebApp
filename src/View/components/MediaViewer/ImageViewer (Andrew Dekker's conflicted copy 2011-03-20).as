...
//			annotationTextOverlayBox.bottom = 0;
			...
			slider.addEventListener(Event.CHANGE, resizeImage);
		}
		...
		private function sourceLoaded(e:Event):void {
			...
			var widthOutOfBounds:Number = scrollerAndOverlayGroup.width - image.contentWidth;
			var heightOutOfBounds:Number = scrollerAndOverlayGroup.height - image.contentWidth;
		...
		private function annotationMouseOver(e:MouseEvent):void {
			...
			// if the annotation is in hte bottom half of the image
			// and in the bottom, if the annotation is in the top half
			if(annotation.isInLowerHalf()) {
