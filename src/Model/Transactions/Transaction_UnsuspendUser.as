package Model.Transactions
{
	...
	public class Transaction_UnsuspendUser
	{
		...
		public function Transaction_UnsuspendUser(username:String, domain:String, callback:Function, connection:Connection):void
		{
			trace("Unsuspending User");
		 ...
		 * 
		 */		
		private function grantIDUserRole():void {
