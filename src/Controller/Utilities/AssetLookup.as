package Controller.Utilities {
	...
	public class AssetLookup extends Object {
		...
		private static var allFilters:FileFilter = new FileFilter("All Accepted File Types", "*.jpg;*.gif;*.png;*.jpeg;*.bmp;*.mov;*.flv;*.mp4;*.avi;*.mpg;*.mpeg;*.wmv;*.mp3;*.wma;*.wavDocument;*.pdf;*.swf;");
		private static var imageFilters:FileFilter = new FileFilter("Images (jpg, gif, png, jpeg)","*.jpg;*.gif;*.png;*.jpeg;*.bmp");
		private static var videoFilters:FileFilter = new FileFilter("Video (mov, flv, mp4, avi, mpg, mpeg)","*.mov;*.flv;*.mp4;*.avi;*.mpg;*.mpeg;*.wmv;");
